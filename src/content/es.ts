...
export const es: Content = {
  ...
  viralPage: {
    ...
    packagesSubtitle:
      "Son nueve metas de crecimiento, en tres franjas. Cada meta trae tres videos virales, que quedan fijados en tu perfil, y el trabajo en los videos que ya publicaste.",
    bands: {
      premium: {
        name: "Premium",
