...
export const pt: Content = {
  ...
  hero: {
    ...
    cta: "Ver planos",
    people: {
      text: "Quem atende é a",
      strong: "equipe da WeCare",
    },
    badge: {
      brand: "Engaja Mais",
      amount: "Até 30",
    ...
    proofs: [
      {
        ...
        description: "atendidas dentro de cada mês",
      },
      {
        title: "Sem senha",
  ...
  plans: {
    ...
    pay: {
      ...
      cardBRWithPix: "Pix ou cartão do Brasil",
      pix: "Pix",
  ...
  viral: {
    ...
    lead: "Estratégias exclusivas para impulsionar seus conteúdos de destaque.",
    cta: "Conhecer",
  },
  faq: {
  ...
  viralPage: {
    eyebrow: "Estratégia Viral",
    title: "Um crescimento que parece natural. Porque tem motivo.",
    ...
    bands: {
      ...
      entry: {
        name: "Start",
        tagline: "O primeiro passo, com a estratégia inteira.",
        pitch: "Para quem está começando e quer sair do zero.",
      },
    },
    bandRecommended: "Mais completo",
    strategyLabel: "Estratégia de crescimento viral",
    ...
    recentNote: "cada vídeo",
    pinnedNote:
      "Os três vídeos virais são os que ficam fixados no seu Instagram.",
    fromLabel: "De {value}",
